...
import tkinter as tk # for GUI window easily
from tkinter import *
...
if __name__ == "__main__":
    # Outcome when run: Tkinter window. Type name then click Compute -> it fills First/Last boxes.
    # Example: 'Benj Rev' => First=Benj, Last=Rev | 'Rev, Benj' => First= Benj, Last=Rev
    main()
